...
2. Locate the file you just downloaded. It ends with an .exe extension.
3. Double-click the file to start the installer. 
4. A window from Windows User Account Control appears. Select Yes to allow the installer to make changes.
5. Choose your preferred language from the list. 
6. Read the license agreement. Select Accept to continue if you agree with the terms.
7. Choose the folder where the software installs. The default folder location works for most users.
8. Follow the prompts on the screen until the installation finishes.
...
The software includes a free version for basic disk management. Some advanced features require a license upgrade.

Does this work on external hard drives?
Yes, the software detects and manages external USB drives just like internal disks.

Can I undo a change?
The software places your tasks in a queue. You must click Apply for the tasks to start. You can cancel tasks before you click Apply.

How long does migration take?
The time depends on the amount of data on your drive and the speed of your connection between the old and new disks.

Do I need to restart my PC?
Some operations require a restart to finish. The software prompts you if this is necessary.